        ...
        <header className="container py-10">
            <div className="flex justify-center items-center ">
                ...
                <div className="w-1/2 sm:w-1/6 sm:block hidden">
                    <div className="logo">
                        <a href="/">
                            <Image src={`https://htmlbeans.com/html/botanical/images/logo.png`} alt="Botanical" width={200} height={50} className="img-fluid" />
                        </a>
                    </div>
                </div>
                ...
                <div className="w-1/2 sm:w-7/12 lg:w-2/3 ">
                    <div className="flex justify-center pt-10 lg:pt-5">
                        <nav className="relative">
                            ...
                            <div className={`absolute   top-full left-0 w-full  ${isNavOpen ? 'block ' : 'hidden '} md:block`}>
                    ...
                    <ul className="flex justify-end pt-10 space-x-4">
                        ...
                        <li className="relative">
                            <button className="block w-6 h-6  relative" >
                                <span className="num rounded-full block bg-red-600 text-white text-center absolute top-0 right-0">2</span>
                        ...
                        <li>
                            <button className="block w-6 h-6 " >
                                ...
                                <Image src={profileIcon} height={15} width={15} alt="profile Icon" />
                            </button>
                        </li>
                    </ul>
                </div>
